...
public class Depense {
    ...
    public Depense(int id,Admin u,double pu, double qte, LocalDate date) {
        this.id = id;
        this.user=u;
        this.pu = pu;
        this.qte = qte;
    ...
    public void save()
    {
        ...
        try {
            ...
            query = "insert into depense (idadmin,quantite,prixunitaire,date) values (?,?,?)";
    ...
    public void update(int id)
    {
        ...
        try {
            ...
            query = "update depense set idadmin=?, quantite =? ,prixunitaire=?,date=? where iddepense=?";
            pstmt=conn.prepareStatement(query);
            java.sql.Date datesql=java.sql.Date.valueOf(this.getDate());
            pstmt.setInt(1, this.getUser().getId());
    ...
    public static Depense getById(int id)
    {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                a = new Depense(id2,user,pu,quantite,date);
            }
    ...
    public static Vector<Depense> getAll()
    {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                double quantite =rs.getDouble("quantite");
                double pu=rs.getDouble("prixunitaire");
                Depense a = new Depense(id2,user,pu,quantite,date);
                ls.add(a);
            }
